...
[`develop`](https://github.com/futureverse/globals/tree/develop) branch
contains the latest contributions and other code that will appear in the
next release, and the [`master`](https://github.com/futureverse/globals)
branch contains the code of the latest release, which is exactly what is
currently on [CRAN](https://cran.r-project.org/package=globals).
...
[globals repository](https://github.com/futureverse/globals). Your PR
should pass `R CMD check --as-cran`, which will also be checked by
[GitHub
Actions](https://github.com/futureverse/globals/actions?query=workflow%3AR-CMD-check)
